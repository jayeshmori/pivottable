            ...
            for own i, c of shownAttributes
                do (c) ->
                    ...
                    showFilterList = (e) ->
                        ...
                        overflow = (e.clientY + filterBoxHeight) > $("body").height() ? true : false

                        if overflow
                            bottomPos = $("body").height() - e.clientY
                            valueList.css(left: clickLeft+10,bottom: bottomPos ).toggle()
                        else
                    ...
                    # Jayesh: Added new feature to Hide the filterBox when clicked outside.
                    $(document).mouseup (e) ->
